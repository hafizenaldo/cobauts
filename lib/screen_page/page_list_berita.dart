...
import 'package:cobauts/screen_page/detail_berita.dart';
import 'package:cobauts/screen_page/page_login.dart';
import 'package:cobauts/utlis/session_manager.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://172.20.10.6/cobauts//getBerita.php"),
      );
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://172.20.10.6/cobauts/gambar_berita/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
